...
# Função que gera os sinônimos das palavras chaves fornecidas em espanhol.
def gerar_sinonimos(palavras_chave):
    ...
    for palavra in palavras_chave:
        ...
        for synset in wn.synsets(palavra, lang='spa'):  # Usando 'spa' para espanhol
...
# Palavras-chaves iniciais traduzidas para o espanhol
automacao = ["automatización", "sistemas automatizados", "tecnología de automatización"]
despoeiramento = ["supresión de polvo", "control de polvo", "gestión de polvo", "eliminación de polvo", "extracción de polvo"]
mineracao = ["minería", "procesamiento de minerales", "procesamiento de mineral", "extracción de minerales"]
...
print("\nLista de sinônimos para Automatización:")
print(lista_automacao)

print("\nLista de sinônimos para Supresión de Polvo:")
print(lista_despoeiramento)

print("\nLista de sinônimos para Minería:")
